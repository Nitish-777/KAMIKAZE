...
export default function ReviewSection({ productId }) {
  ...
  return (
    <div style={{ marginTop: '3rem', borderTop: '1px solid var(--color-border)', paddingTop: '2rem' }}>
      ...
      {/* Write Review Form — only for users with delivered orders */}
      {canReview && (
      ...
      {/* Sign in prompt */}
      {!isAuthenticated && (
        <div style={{ background: 'var(--color-bg-alt)', border: '1px solid var(--color-border)', borderRadius: 'var(--rounded-md)', padding: '1rem', marginBottom: '1.5rem', textAlign: 'center' }}>
          <p style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem' }}>
            Sign in and purchase this product to write a review.
          </p>
        </div>
      )}
